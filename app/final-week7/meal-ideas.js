            ...
            <ul className="flex flex-col gap-4">
                {
                    ...
                    meals.map(
                        (meal) => (
                            <li key={meal} className="text-md p-2 pt-4 pb-2 border-b rounded-t-md rounded-b-sm border-gray-800 hover:bg-gray-800 hover:border-gray-700 hover:text-white hover:cursor-pointer ">
                                {meal["strMeal"]}
                            </li>
                        )
                    )
